 ...
 * Description: Guided example - the Book classg++
...
class Book
{
    ...
    public:
        ...
        //Status shows "available" because isCheckedOut is false by default in the constructor.
...
int main() {
    ...
    b1.setAuthor("");   // empty string - should be REJECTED // condition rejects empty string.
    b1.printInfo();
